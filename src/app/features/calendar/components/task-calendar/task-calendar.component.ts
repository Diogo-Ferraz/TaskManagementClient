...
export class TaskCalendarComponent implements OnInit, OnDestroy {
  ...
  private createPreviewTasks(): TaskItemDto[] {
    ...
    return [
      ...
      {
        id: 'preview-task-5',
        title: 'Audit API validation edge cases',
        description: 'Confirm all contract validations return actionable messages.',
        status: 1,
        dueDate: createIso(2),
        projectId: 'project-delta',
        projectName: 'Delta Ops',
        assignedUserId: 'debug-user',
        assignedUserName: 'Debug User',
        createdAt: nowIso,
        createdByUserId: 'debug-user',
      ...
      },
      {
        ...
        description: 'Ensure all workspace setup steps are documented.',
        status: 0,
        dueDate: createIso(2),
        projectId: 'project-epsilon',
        projectName: 'Epsilon Docs',
        assignedUserId: null,
      ...
      {
        id: 'preview-task-7',
        title: 'Tune activity feed batching',
        description: 'Reduce redundant redraws under burst updates.',
        status: 1,
        dueDate: createIso(2),
        projectId: 'project-gamma',
        projectName: 'Gamma Services',
      ...
      {
        id: 'preview-task-8',
        title: 'Cross-browser visual QA',
        description: 'Validate key views on Safari, Chrome and Firefox.',
        status: 0,
        dueDate: createIso(2),
        projectId: 'project-beta',
        projectName: 'Beta Workspace',
      ...
      },
      {
        ...
        description: 'Split oversized tasks and re-prioritize near-term sprint scope.',
        status: 1,
        dueDate: createIso(2),
        projectId: 'project-alpha',
        projectName: 'Alpha Platform',
      ...
      },
      {
        ...
        description: 'Capture notable changes and migration guidance.',
        status: 2,
        dueDate: createIso(2),
        projectId: 'project-delta',
        projectName: 'Delta Ops',
